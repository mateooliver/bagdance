...
const Materiales = () => {
  return (
    <div className='mt-4'>
        ...
        <div className=' d-flex text-start '  style={{width:"80vw", }}>
        <img  style={{height:'250px', width:'500px', borderRadius:"10px", margin:"auto 20px auto auto"}} src={require('../img/materiales.png')} alt="Nuestra Historia" />
            <div className='my-auto'>
            <h1 className='text-start my-2 text-secondary'>Materiales pensados especificamente para nuestra pasion: la danza</h1>
            <p style={{fontSize:"13px", }}>Los productos de Bagdance fueron pensados para que sean una extensión del bailarín. Por eso, se eligieron textiles livianos y suaves, pero resistentes.
